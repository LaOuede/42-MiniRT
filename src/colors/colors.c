...
t_color get_specular_color(t_color obj_color, t_hit *hit, float color_intensity)/////////////////play around here
{
    ...
    color_intensity = pow(color_intensity, 1.2) * 255.0f * get_obj_material(hit->obj)->specular_factor;
